...
- [x] 9. Checkpoint — Verificar camino feliz end-to-end
  ...
  **Nota de validación**: Confirmado manualmente en navegador (localhost:5173) contra API real en AWS — no solo datos mockeados. Upload real de PDF, flujo completo hasta Results con resultado renderizado correctamente, sin errores de consola.
...
- [x]* 12. Tests unitarios de componentes (UploadZone, RiskScore, ClauseCard, SuggestedQuestions)
...
- [x]* 13. Tests unitarios de páginas (Home, Results)
...
- [x]* 15. Property-based tests con fast-check
...
- [x] 16. Checkpoint — Verificar que todos los tests pasan
  ...
  **Nota de validación**: npm run test -- --run: 57 passed (57), 9 test files, 0 fallos. Confirmado en sesión previa de auditoría (OpenCode).
